...
GO
PRINT N'Выполняется создание [dbo].[Administrators]...';
...
GO
PRINT N'Выполняется создание [dbo].[Masters]...';
...
GO
PRINT N'Выполняется создание [dbo].[OrderDetails]...';
...
CREATE TABLE [dbo].[OrderDetails] (
    ...
    PRIMARY KEY CLUSTERED ([OrderId] ASC, [ServiceId] ASC) ON [PRIMARY]
) ON [PRIMARY];
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a92cc1b1-7318-4368-811f-271ba347a589')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a92cc1b1-7318-4368-811f-271ba347a589')
